 ...
 */
class ViroActivityAR : Activity(), ARScene.Listener {
    ...
    private fun onRenderCreate() {
        ...
        val teslaLogoTargetBmp = getBitmapFromAssets("alteKarte_ohne.png")
...
private fun initColorPickerModels(groupNode: Node) {
  ...
  mColorChooserGroupNode!!.transformBehaviors = EnumSet.of<Node.TransformBehavior>(Node.TransformBehavior.BILLBOARD_Y)
...
companion object {
  private val TAG = ViroActivityAR::class.java.getSimpleName()
}
}